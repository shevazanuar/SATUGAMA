                ...
                >
                  ...
                  <div className="p-6 flex flex-col flex-1 gap-4">
                    ...
                    <div className="pt-3 border-t border-white/6 flex gap-2">
                      ...
                      <a
                        href={`https://wa.me/62882005486575?text=Halo%20SatuGama!%20%F0%9F%91%8B%20Saya%20tertarik%20dengan%20*${encodeURIComponent(item.title)}*%20(${encodeURIComponent(item.price)}).%20Bisa%20info%20cara%20pembeliannya%3F%20%F0%9F%8E%AE`}
                        target="_blank"
                        rel="noopener noreferrer"
                        className={`flex-1 flex items-center justify-center gap-1.5 py-2.5 rounded-xl border ${item.ctaBorderDetail} text-xs font-semibold transition-all duration-200 hover:opacity-80`}
                      >
                        Pesan
                      </a>
                    </div>
        ...
        <div className="max-w-6xl mx-auto px-5">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl mx-auto">
            ...
            <div className="relative p-8 rounded-2xl border border-white/8 bg-[#0e1020]/60 flex flex-col gap-6 card-hover">
              ...
              <a
                href="https://wa.me/62882005486575?text=Halo%20SatuGama!%20%F0%9F%91%8B%20Saya%20tertarik%20dengan%20*Indie%20Pack%20(Rp%2029.000)*%20dan%20ingin%20tahu%20lebih%20lanjut%20cara%20pembeliannya.%20Terima%20kasih!%20%F0%9F%8E%AE"
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center justify-center gap-2 py-3 rounded-xl border border-white/12 bg-white/5 hover:bg-emerald-500/15 hover:border-emerald-500/30 text-slate-300 hover:text-emerald-300 font-semibold text-sm transition-all duration-200 group"
              >
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="h-4 w-4 fill-current transition-colors" aria-hidden="true"><path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 01-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 01-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 012.893 6.994c-.003 5.45-4.437 9.884-9.885 9.884m8.413-18.297A11.815 11.815 0 0012.05 0C5.495 0 .16 5.335.157 11.892c0 2.096.547 4.142 1.588 5.945L.057 24l6.305-1.654a11.882 11.882 0 005.683 1.448h.005c6.554 0 11.89-5.335 11.893-11.893a11.821 11.821 0 00-3.48-8.413z"/></svg>
                Pilih Paket Ini
              </a>
            </div>
            ...
            <div className="relative p-8 rounded-2xl border border-indigo-500/40 bg-indigo-500/5 flex flex-col gap-6 shadow-2xl shadow-indigo-500/12 scale-[1.02]">
              ...
              <a
                href="https://wa.me/62882005486575?text=Halo%20SatuGama!%20%F0%9F%91%8B%20Saya%20mau%20order%20*Starter%20Pack%20(Rp%2049.000)*%20yang%20paling%20populer.%20Bisa%20info%20langkah%20selanjutnya%3F%20Terima%20kasih!%20%F0%9F%8E%AE"
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center justify-center gap-2 py-3 rounded-xl btn-primary text-white font-bold text-sm hover:scale-[1.02] transition-transform"
              >
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="h-4 w-4 fill-current" aria-hidden="true"><path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 01-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 01-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 012.893 6.994c-.003 5.45-4.437 9.884-9.885 9.884m8.413-18.297A11.815 11.815 0 0012.05 0C5.495 0 .16 5.335.157 11.892c0 2.096.547 4.142 1.588 5.945L.057 24l6.305-1.654a11.882 11.882 0 005.683 1.448h.005c6.554 0 11.89-5.335 11.893-11.893a11.821 11.821 0 00-3.48-8.413z"/></svg>
                Mulai Sekarang
              </a>
            </div>
            ...
            <div className="relative p-8 rounded-2xl border border-white/8 bg-[#0e1020]/60 flex flex-col gap-6 card-hover">
              ...
              <a
                href="https://wa.me/62882005486575?text=Halo%20SatuGama!%20%F0%9F%91%8B%20Saya%20tertarik%20dengan%20*Custom%20Pack*%20untuk%20kebutuhan%20aset%20eksklusif.%20Bisa%20kita%20diskusikan%20lebih%20lanjut%3F%20Terima%20kasih!%20%F0%9F%8E%AE"
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center justify-center gap-2 py-3 rounded-xl border border-amber-500/30 bg-amber-500/8 hover:bg-amber-500/25 hover:border-amber-500/50 text-amber-300 hover:text-amber-100 font-semibold text-sm transition-all duration-200 group"
              >
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="h-4 w-4 fill-current transition-colors" aria-hidden="true"><path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 01-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 01-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 012.893 6.994c-.003 5.45-4.437 9.884-9.885 9.884m8.413-18.297A11.815 11.815 0 0012.05 0C5.495 0 .16 5.335.157 11.892c0 2.096.547 4.142 1.588 5.945L.057 24l6.305-1.654a11.882 11.882 0 005.683 1.448h.005c6.554 0 11.89-5.335 11.893-11.893a11.821 11.821 0 00-3.48-8.413z"/></svg>
                Diskusi Kebutuhan
              </a>
